/*
  ...
  - You are about to drop the column `usuarioId` on the `cargo` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "cargo" DROP CONSTRAINT "cargo_usuarioId_fkey";

-- AlterTable
ALTER TABLE "cargo" DROP COLUMN "usuarioId";
